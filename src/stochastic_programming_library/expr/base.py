"""Runtime implementation intentionally deferred; see ``base.pyi``.

The commented section below preserves the superseded mutable prototype while
the node-oriented contracts are being finalized.
"""
